...
describe('Most favourite blog', ()=>{
  ...
  test('The blog has most likes is Canonical string reduction', ()=>{
...
describe('The author who has most blogs', ()=>{
  const blogs =  [
    {
      _id: "5a422a851b54a676234d17f7",
      title: "React patterns",
...
describe('The author who has most likes of the blog, has total likes', ()=>{
  const blogs =  [
    {
      _id: "5a422a851b54a676234d17f7",
      title: "React patterns",
